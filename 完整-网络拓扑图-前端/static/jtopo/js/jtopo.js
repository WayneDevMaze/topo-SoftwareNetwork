...
function (window) {
    function Element() {
        ...
        this.toJson = function () {//toJson-element
            var a = this,
                b = "{",
...
//舞台搭建 Stage类 Jtop.Stage =c  function c  comment lxf
function (a) {
    function b(a) {
        return {
            hgap: 16,
    ...
    function c(c) {//  Jtop.Stage=c   参数 c 表示  Canvas  comment lxf
        function d(b) {
        ...
        a.stage = this;//a-->jTop
        var n = this;
        this.initialize = function (c) {//c --->canvas
            m(c),
            this.canvas = c,
        ...
        this.toJson = function () {//json-stage
            {
                var b = this,
                    c = '{"version":"' + a.version + '",';
...
//情景 Scene类   JTop.Secne=b  b.prototype = new a.Element;
function (a) {
    function b(c) {
        function d(a, b, c, d) {
            return function (e) {
        ...
        this.toJson = function () {//toJson-scene
            {
                var a = this,
                    b = "{";
                this.serializedProperties.length
...
//定义 Jtop.None TextNode LinkNode CircleNode  AnimateNode
function (a) {
    function b(c) {
    ...
    c.prototype = new b,  //c的原型是b   byliuxf
    d.prototype = new c,//textNode
    e.prototype = new d,  //LinkNode
    f.prototype = new c,  
...
//定义jTop.Link FoldLink  FlexionalLink CurveLink
function (a) {
    function b(a, b) {
        var c = [];
    ...
    function f(b, c, g) {// link liuxf 连接线路  b nodeA , c NodeZ
        function h(b, c) {
        ...
        this.initialize = function (b, c, d) {  //b nodeA ,c NodeZ , d text
            if (f.prototype.initialize.apply(this, arguments), this.elementType = "link", this.zIndex = a.zIndex_Link, 0 != arguments.length) {
                ...
                null != this.nodeA && this.nodeA.outLinks.push(this),  //出度
                null != this.nodeZ && this.nodeZ.inLinks.push(this),    //入度
                this.caculateIndex(),
                this.font = "12px Consolas",
                this.fontColor = "255,255,255",
                this.lineWidth = 2,
        ...
        this.getPath = function () {
            ...
            if(this.polyPoints.length>1 ){
                b=this.polyPoints[this.polyPoints.length-1];
            }
            else if (1 == d) return [b, c]//只有一个点，另一个点移动中。。。。。。
    ...
    function j(a, b, c,d) {//polyLine  a nodeA; b nodeB; c Text； d：polyPoints
        this.initialize = function () {
            j.prototype.initialize.apply(this, arguments),
                this.direction = "vertical",
                this.offsetGap = 44
        },
        this.initialize(a, b, c), this.polyPoints=d,
        this.getPath = function (a) {
            var a = [],
                b = this.getStartPosition(),
                c = this.getEndPosition();
...
//定义jTop.Container  继承自jTop.InteractiveElement,
function (a) {
    function b(c) {
        this.initialize = function (c) {
...
/*定义jTop.layout
 layoutNode: r,  getNodeChilds: q, adjustPosition: p,springLayout: s, getTreeDeep: t,
 getRootNodes: g,GridLayout: d,FlowLayout: e,AutoBoundLayout: f,
 CircleLayout: l, TreeLayout: k, getNodesCenter: b, circleLayoutNodes: c
*/
function (a) {
    function b(a) {
        var b = 0,
...
//定义jTop.BarChartNode -->function c; jTop.PieChartNode--->b
function (a) {
    function b() {
